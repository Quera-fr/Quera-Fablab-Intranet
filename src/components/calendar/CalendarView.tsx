							...
							{isSelectionMode ? (
								<>
									<button
										...
										className="flex items-center gap-2 bg-red-500 text-white px-3 py-1.5 rounded-lg hover:bg-red-600 transition-all font-bold text-xs uppercase tracking-wider shadow-lg"
									>
									...
									<button
										...
										className="flex items-center gap-2 bg-zinc-200 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 px-3 py-1.5 rounded-lg hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-all font-bold text-xs uppercase tracking-wider"
									>
										Annuler
									</button>
								</>
